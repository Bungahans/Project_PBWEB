...
<nav class="navigasi" navbar-fixed-stop>
    ...
    <div class="background">
        ...
        <div class="follow">
            <a href="instagram.com" ><img src="gambar/logo-instagram.png" alt="" id="follow"></a>
			<a href="instagram.com" ><img src="gambar/logo-google.png" alt="" id="follow"></a>
			<a href="instagram.com" ><img src="gambar/logo-facebook.png" alt="" id="follow"></a>
        </div>
    </div>
    ...
    <section id="about">
        <div class="about-us">
            <div class="bg">
                <div class="tulisan">
                    <h1>ABOUT</h1>
                    <p>Disini kami ingin menjadikan objek wisata di daerah kami semakin terkenal dengan keramahan warga dan penyedia jasa, setiap orang luar daerah sini diwajibkan memakai jasa antar yang telah disediakan dikarenakan kondisi jalan yang kurang memadai dan juga demi keselamatan pengunjung</p>
                </div>    
            </div>
        </div>
    </section>
